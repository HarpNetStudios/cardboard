...
#ifndef STANDALONE
oldstring cmrname, bakname, cfgname, bcfgname, picname, loadname;
...
void setmapfilenames(const char *fname, const char *cname = NULL)
{
	...
	formatstring(bcfgname, "packages/%s_%d.cfg.BAK", mapname, totalmillis);
...
void writemapcfg(const char* a)
{
	...
	conoutf("successfully generated mapdata cfg: %s", cfgname);
}
...
bool load_world(const char *mname, const char *cname)        // still supports all map formats that have existed since the earliest cube betas!
{
	...
	//oldstring blah; formatstring(blah, "%s.cmr", mname);
