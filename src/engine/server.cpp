...
#ifdef WIN32
	MessageBox(NULL, msg, "Cardboard Engine fatal error", MB_OK|MB_SYSTEMMODAL);
#else
...
Uint64 lastupdatemaster = 0, lastconnectmaster = 0, masterconnecting = 0, masterconnected = 0;
...
#ifdef STANDALONE
Uint64 curtime = 0, lastmillis = 0, elapsedtime = 0, totalmillis = 0;
#endif
...
void initserver(bool listen, bool dedicated)
{
	...
	{
#ifdef WIN32
		setupwindow("Cardboard Engine server");
#endif
	}
