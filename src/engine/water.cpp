...
#define WATERVARS(name) \
    bvec name##color_i(0x14, 0x46, 0x50), name##fallcolor_i(0, 0, 0); \
...
GETMATIDXVAR(water, color_i, const bvec &)
...
GETMATIDXVAR(lava, color_i, const bvec &)
...
void renderwater()
{
    ...
    loopi(MAXREFLECTIONS)
    {
        ...
        gle::color(getwatercolor_i(ref.material));
...
{
    const bvec &wcol = getwatercolor_i(ref.material);
