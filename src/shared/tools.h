...
extern void putu64(ucharbuf& p, Uint64 n);
extern void putu64(packetbuf& p, Uint64 n);
extern void putu64(vector<uchar>& p, Uint64 n);
extern Uint64 getu64(ucharbuf& p);
